...
<?php if (isset($selectedParent)):?>
 ...
 <div class="x_panel">
  <div class="x_title">
    <h2>Kind toevoegen aan <b><?php echo $selectedParent['voornaam']." ".$selectedParent['familienaam']  ?></b> </h2>
    <ul class="nav navbar-right panel_toolbox">
      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
      </ul>
      <div class="clearfix"></div>
  ...
  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12">Mag op de foto<span class="required">*</span></label>
    <div class="col-md-6 col-sm-6 col-xs-12">
      <div id="onPhoto" class="btn-group" data-toggle="buttons">
        <label class="btn btn-primary <?php if ($_POST['onPhoto'] == "1"): echo "active"; endif; ?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
          <input type="radio" name="onPhoto" value="1" <?php if (isset($_POST['onPhoto']) && $_POST['onPhoto'] == "1") echo 'checked="true"' ?> > &nbsp; Ja &nbsp;
        </label>
        <label class="btn btn-primary <?php if ($_POST['onPhoto'] == "0"): echo "active"; endif; ?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
          <input type="radio" name="onPhoto" value="0" <?php if (isset($_POST['onPhoto']) && $_POST['onPhoto'] == "0") echo 'checked="true"' ?> > Neen
        </label>
      </div>
      <span class="error" style="color: #BA383C;"><?php if(!empty($errors['onPhoto'])) echo "<p class=\"error\" style=\"color: #BA383C;\">{$errors['onPhoto']}</p>";?></span>
    </div>
  </div>
