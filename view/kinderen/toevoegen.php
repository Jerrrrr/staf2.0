     ...
     <div class="x_title">
       ...
       <div class="x_content">
        ...
        <form method="POST" action="index.php?page=voegtoe&button=nieuw" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
         ...
         <div class="form-group">
          <label for="tel2" class="control-label col-md-3 col-sm-3 col-xs-12">Info over het plein ontvangen <span class="required">*</span></label>
           <div class="col-md-6 col-sm-6 col-xs-12">
            <div id="functie" class="btn-group" data-toggle="buttons">
             <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
               <input type="radio" name="ontvanginfo" value="j" <?php if (!empty($_POST['ontvanginfo']) && $_POST['ontvanginfo'] == "m"): echo "checked"; endif; ?> > &nbsp; Ja &nbsp;
             </label>
             <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
               <input type="radio" name="ontvanginfo" value="n" <?php if (!empty($_POST['ontvanginfo']) && $_POST['ontvanginfo'] == "p"): echo "checked"; endif; ?>> Nee
             </label>
           </div>
           <span class="error" style="color: #BA383C;"><?php if(!empty($errors['ontvanginfo'])) echo "<p class=\"error\" style=\"color: #BA383C;\">{$errors['ontvanginfo']}</p>";?></span>
           </div>
         </div>
