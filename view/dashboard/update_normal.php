					...
					<form id="demo-form2" data-parsley-validate method="POST" action="index.php?page=update_normal" class="form-horizontal form-label-left">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="password" id="password" name="password" required="required" placeholder="Nieuw wachtwoord" class="form-control col-md-7 col-xs-12">
								<?php if(!empty($errors['password'])) echo '<span class="error">' . $errors['password'] . '</span>';?>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="confirmpassword">Wachtwoord bevestigen
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="confirmpassword" id="confirmpassword" name="confirmpassword" required="required" placeholder="Nieuw wachtwoord" class="form-control col-md-7 col-xs-12">
